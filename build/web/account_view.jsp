                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card" style="width: 40rem; margin: auto">
                            <h4 class="card-title d-flex justify-content-center" style="margin-top: 10px">Thông Tin Tài Khoản</h4> 
                            <div class="d-flex justify-content-center" style="margin-top: 20px">
                                <img src="${detail.avatar}" alt="avatar" width="60%">
                            </div>
                            <div class="card-body">
                                <p class="card-text d-flex justify-content-center"><strong>Tên Người Dùng: </strong> ${detail.username}</p>
                                <p class="card-text d-flex justify-content-center"><strong>Email: </strong> ${detail.email}</p>
                                <p class="card-text d-flex justify-content-center"><strong>Số Điện Thoại: </strong> ${detail.phone}</p>
                            </div>
                        </div>
                        <!-- /.container-fluid -->
                    </div>
