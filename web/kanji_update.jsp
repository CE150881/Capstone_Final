                                        ...
                                        <form action="UpdateKanjiControl" method="post">
                                            ...
                                            <div class="modal-body">	
                                                ...
                                                <div class="form-group">
                                                    <label>Kanji</label>
                                                    <input value="${detail.kanji}" name="kanji" type="text" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Nghĩa</label>
                                                    <input value="${detail.meaning}" name="meaning" type="text" class="form-control" required>
                                                </div>                                                    
                                                <div class="form-group">
                                                    <label>Cấp Độ</label>
