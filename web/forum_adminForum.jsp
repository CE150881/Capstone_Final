...
<html lang="en">
    ...
    <body id="page-top">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <img class="img-profile rounded-circle"
                                         src="${pageContext.request.contextPath}/manage/img/undraw_profile.svg">
                                </a>
        ...
        <script src="${pageContext.request.contextPath}/https://code.jquery.com/jquery-3.5.1.js"></script>
