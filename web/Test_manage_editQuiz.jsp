<%-- 
    Document   : editQuiz
    Created on : Oct 12, 2022, 12:06:43 AM
    Author     : Saing
--%>
                             ...
                             <div id="editEmployeeModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="${pageContext.request.contextPath}/quizEdit" method="post">                         
                                            <div class="modal-header">                      
                                                <h4 class="modal-title">Cập Nhật Quiz</h4>
                                            </div>
                                            <div class="modal-body">    
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="test" value="${test}" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Câu hỏi:</label>
                                                    <input type="text" name="question" value="${question}" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="quizControl" class="btn btn-default" tabindex="-1" role="button">Hủy</a>
