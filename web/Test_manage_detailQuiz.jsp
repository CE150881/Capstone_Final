<%-- 
    ...
    Created on : Oct 12, 2022, 12:06:02 AM
    Author     : Saing
--%>
...
<!--                                <div class="col-sm-6">
                        ...
                        <br>
                        <form action="${pageContext.request.contextPath}/quizControl" method="post">
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    <c:forEach items="${listQuiz}" var="o" varStatus="i">
                                        <tr>
                                            <td>${i.index+1}</td>
                                            <td>${o.name}</td>
                                            <td>
                                                <c:forEach items="${listTest}" var="z">
                                                    <c:if test="${o.testID.equals(z.testID)}">
                                                        ${z.name}
                                                    </c:if>
                                                </c:forEach>
                                            </td>
                                            <td>
                                                <c:forEach items="${listQues}" var="x">
                                                    <c:if test="${o.questionID.equals(x.questionID)}">
                                                        ${x.question}
                                                    </c:if>
                                                </c:forEach>
                                            </td>
                                            <td>
                                                <a class="btn btn-secondary" tabindex="-1" role="button" href="quizEdit?quizID=${o.quizID}">Cập Nhật</a>
                                                <a class="btn btn-danger" tabindex="-1" role="button" onclick="showMess(${o.quizID})">Xoá</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                    ...
                    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="${pageContext.request.contextPath}/quizCreate" method="post">
                                    <div class="modal-header">                      
                                        <h4 class="modal-title">Thêm quiz mới</h4>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" class="btn btn-success" value="Submit" role="button"/>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
                                                    ...
                                                    function showMess(ID) {
                                                        ...
                                                        if (option === true) {
                                                            window.location.href= '${pageContext.request.contextPath}/quizDelete?quizID='+ID;
                                                        }
                                                    }
                                                    ;
        </script>
