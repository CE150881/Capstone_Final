                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2>Quản Lí Câu Trả Lời</h2>
                                    <p>Câu Hỏi: ${question}</p>
                                </div>
                                <div class="col-sm-6">
                                    <a href="#add" class="btn btn-success" data-toggle="modal" data-target="#add" 
                                       style="margin-left: 450px; background-color: #000000; border-color: #000000;"><span>Tạo Câu Trả Lời Mới</span></a>                                             
                                </div>
                            </div>
                        </div>
                        <br>
                        <form action="answerControl" method="POST">
                                    ...
                                    <c:forEach items="${listAnswer}" var="o" varStatus="i">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <a href="insertTest_EditAnswer?answerID=${o.answerID}" class="btn btn-secondary" tabindex="-1" role="button">
                            ...
                            <a href="insertTest_Test" class="btn btn-outline-danger" tabindex="-1" role="button">Quay lại</a>
                        </form> 
                    </div> 
                    ...
                    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="${pageContext.request.contextPath}/insertTest_CreateAnswer" method="post">
                                    ...
                                    <div class="modal-body">    
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input placeholder="0 là sai, 1 là đúng" type="text" name="isCorrect" class="form-control" required/>
                                        </div>
