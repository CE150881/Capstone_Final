 ...
 * @author A Hi
 */
@WebServlet(name = "LoadKanjiControl", urlPatterns = {"/LoadKanjiControl"})
public class LoadKanjiControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("kanji_update.jsp").forward(request, response);
    }
