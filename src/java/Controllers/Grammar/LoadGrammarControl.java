 ...
 * @author A Hi
 */
@WebServlet(name = "LoadGrammarControl", urlPatterns = {"/LoadGrammarControl"})
public class LoadGrammarControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("grammar_update.jsp").forward(request, response);
    }
