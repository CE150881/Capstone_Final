...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet testEditController</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet testEditController at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
...
//        processRequest(request, response);
        ...
        Test test = dao.getTestByID(Integer.parseInt(ID));
        ...
        request.getRequestDispatcher("Test_manage_editTest.jsp").forward(request, response);
    }
